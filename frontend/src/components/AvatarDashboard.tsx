      ...
      {!isLoading && avatar && avatar.photo !== "" && (
        <div className="flex items-center gap-2">
          <img
            src={avatar.photo}
            alt="avatar"
            className="w-10 h-10 rounded-full object-cover border-2 border-layer-primary"
          />
        </div>
      )}
      {!isLoading && avatar && avatar.photo === "" && (
        <div className="w-10 h-10 rounded-full bg-layer-secondary border-2 border-layer-primary flex items-center justify-center">
